 ...
 */
final class Version20250103103633 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE web_block (id INT AUTO_INCREMENT NOT NULL, multi_store_id INT NOT NULL, type VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, type_id INT NOT NULL, `order` INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE web_footer (id INT AUTO_INCREMENT NOT NULL, multi_store_id INT NOT NULL, title VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, `order` INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE web_footer_body (id INT AUTO_INCREMENT NOT NULL, web_footer_id INT NOT NULL, logo VARCHAR(255) NOT NULL, about VARCHAR(255) NOT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE web_footer_link (id INT AUTO_INCREMENT NOT NULL, web_footer_body_id INT NOT NULL, title VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, link VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE web_footer_link');
