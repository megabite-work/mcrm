 ...
 */
final class Version20240819073005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE counter_part (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, multi_store_id INT NOT NULL, inn VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, discount NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_682A9A1F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
