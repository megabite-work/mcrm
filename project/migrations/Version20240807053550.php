 ...
 */
final class Version20240807053550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, name JSON NOT NULL COMMENT \'(DC2Type:json)\', image VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_64C19C1727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE multi_store (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, owner_id INT NOT NULL, name VARCHAR(255) NOT NULL, profit LONGTEXT DEFAULT NULL, barcode_TTN VARCHAR(255) DEFAULT NULL, nds INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_A869D5ABF5B7AF75 (address_id), INDEX IDX_A869D5AB7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nomenclature (id INT AUTO_INCREMENT NOT NULL, provider_id INT DEFAULT NULL, category_id INT DEFAULT NULL, unit_id INT DEFAULT NULL, mxik VARCHAR(255) NOT NULL, barcode VARCHAR(255) NOT NULL, brand VARCHAR(255) NOT NULL, name JSON NOT NULL COMMENT \'(DC2Type:json)\', oldprice NUMERIC(15, 3) NOT NULL, price NUMERIC(15, 3) NOT NULL, oldprice_course NUMERIC(15, 3) NOT NULL, price_course NUMERIC(15, 3) NOT NULL, nds NUMERIC(15, 3) NOT NULL, discount NUMERIC(15, 3) NOT NULL, qr_code VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_799A3652A53A8AA (provider_id), INDEX IDX_799A365212469DE2 (category_id), INDEX IDX_799A3652F8BD700D (unit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nomenclature_history (id INT AUTO_INCREMENT NOT NULL, store_id INT DEFAULT NULL, nomenclature_id INT DEFAULT NULL, forgive_type_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, comment VARCHAR(255) NOT NULL, qty NUMERIC(10, 2) NOT NULL, oldprice NUMERIC(10, 2) NOT NULL, price NUMERIC(10, 2) NOT NULL, oldprice_course NUMERIC(10, 2) NOT NULL, price_course NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_C77D427EB092A811 (store_id), INDEX IDX_C77D427E90BFD4B8 (nomenclature_id), INDEX IDX_C77D427EF920CE6F (forgive_type_id), INDEX IDX_C77D427E7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE store_nomenclature (id INT AUTO_INCREMENT NOT NULL, store_id INT DEFAULT NULL, nomenclature_id INT DEFAULT NULL, qty NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_6EF31D66B092A811 (store_id), INDEX IDX_6EF31D6690BFD4B8 (nomenclature_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE unit (id INT AUTO_INCREMENT NOT NULL, name JSON NOT NULL COMMENT \'(DC2Type:json)\', code INT NOT NULL, icon VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE web_nomenclature (id INT AUTO_INCREMENT NOT NULL, multi_store_id INT DEFAULT NULL, nomenclature_id INT DEFAULT NULL, article VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, document VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_FE9BA2AC7B4D9FBF (multi_store_id), UNIQUE INDEX UNIQ_FE9BA2AC90BFD4B8 (nomenclature_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE web_nomenclature ADD CONSTRAINT FK_FE9BA2AC7B4D9FBF FOREIGN KEY (multi_store_id) REFERENCES multi_store (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_nomenclature DROP FOREIGN KEY FK_FE9BA2AC7B4D9FBF');
