 ...
 */
final class Version20240810070242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, region VARCHAR(255) NOT NULL, district VARCHAR(255) NOT NULL, street VARCHAR(255) NOT NULL, house VARCHAR(255) DEFAULT NULL, latitude VARCHAR(255) DEFAULT NULL, longitude VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, name JSON NOT NULL COMMENT \'(DC2Type:json)\', image VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, INDEX IDX_64C19C1727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE counter_part (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, multi_store_id INT NOT NULL, stir VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, discount NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_682A9A1F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE course (id INT AUTO_INCREMENT NOT NULL, multi_store_id INT NOT NULL, currency_id INT NOT NULL, cape_amount NUMERIC(10, 2) NOT NULL, cape_type VARCHAR(255) NOT NULL, `convert` INT NOT NULL, currency_value NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE currency (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE forgive_type (id INT AUTO_INCREMENT NOT NULL, name JSON NOT NULL COMMENT \'(DC2Type:json)\', created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE move_detail (id INT AUTO_INCREMENT NOT NULL, status VARCHAR(255) NOT NULL, store_sender_id INT NOT NULL, store_receiver_id INT NOT NULL, user_sender_id INT NOT NULL, user_receiver_id INT NOT NULL, total_qty NUMERIC(10, 2) NOT NULL, total_price NUMERIC(10, 2) NOT NULL, total_item INT NOT NULL, comment VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE move_global (id INT AUTO_INCREMENT NOT NULL, status VARCHAR(255) NOT NULL, move_detail_id INT NOT NULL, nomenclature_id INT NOT NULL, qty NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE multi_store (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, owner_id INT NOT NULL, name VARCHAR(255) NOT NULL, profit LONGTEXT DEFAULT NULL, barcode_TTN BIGINT DEFAULT 5752022000000, nds INT DEFAULT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_A869D5ABF5B7AF75 (address_id), INDEX IDX_A869D5AB7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nomenclature (id INT AUTO_INCREMENT NOT NULL, provider_id INT DEFAULT NULL, multi_store_id INT NOT NULL, category_id INT NOT NULL, unit_id INT DEFAULT NULL, mxik VARCHAR(255) DEFAULT NULL, barcode BIGINT NOT NULL, brand VARCHAR(255) DEFAULT NULL, name JSON NOT NULL COMMENT \'(DC2Type:json)\', oldprice NUMERIC(15, 3) DEFAULT \'0\' NOT NULL, price NUMERIC(15, 3) DEFAULT \'0\' NOT NULL, oldprice_course NUMERIC(15, 3) DEFAULT \'0\' NOT NULL, price_course NUMERIC(15, 3) DEFAULT \'0\' NOT NULL, nds NUMERIC(15, 3) DEFAULT \'0\' NOT NULL, discount NUMERIC(15, 3) DEFAULT \'0\' NOT NULL, qr_code TINYINT(1) DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, INDEX IDX_799A3652A53A8AA (provider_id), INDEX IDX_799A36527B4D9FBF (multi_store_id), INDEX IDX_799A365212469DE2 (category_id), INDEX IDX_799A3652F8BD700D (unit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nomenclature_history (id INT AUTO_INCREMENT NOT NULL, store_id INT NOT NULL, nomenclature_id INT NOT NULL, forgive_type_id INT DEFAULT NULL, owner_id INT NOT NULL, comment LONGTEXT DEFAULT NULL, qty NUMERIC(10, 2) DEFAULT NULL, oldprice NUMERIC(10, 2) DEFAULT NULL, price NUMERIC(10, 2) DEFAULT NULL, oldprice_course NUMERIC(10, 2) DEFAULT NULL, price_course NUMERIC(10, 2) DEFAULT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, INDEX IDX_C77D427EB092A811 (store_id), INDEX IDX_C77D427E90BFD4B8 (nomenclature_id), INDEX IDX_C77D427EF920CE6F (forgive_type_id), INDEX IDX_C77D427E7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE phone (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, store_id INT DEFAULT NULL, multi_store_id INT DEFAULT NULL, counter_part_id INT DEFAULT NULL, phone VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, INDEX IDX_444F97DD7E3C61F9 (owner_id), INDEX IDX_444F97DDB092A811 (store_id), INDEX IDX_444F97DD7B4D9FBF (multi_store_id), INDEX IDX_444F97DDC28817CD (counter_part_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE provider_list (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, value VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE store (id INT AUTO_INCREMENT NOT NULL, multi_store_id INT NOT NULL, address_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, INDEX IDX_FF5758777B4D9FBF (multi_store_id), UNIQUE INDEX UNIQ_FF575877F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE store_user (store_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_6F2A7887B092A811 (store_id), INDEX IDX_6F2A7887A76ED395 (user_id), PRIMARY KEY(store_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE store_nomenclature (id INT AUTO_INCREMENT NOT NULL, store_id INT NOT NULL, nomenclature_id INT NOT NULL, qty NUMERIC(10, 2) DEFAULT \'0\' NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, INDEX IDX_6EF31D66B092A811 (store_id), INDEX IDX_6EF31D6690BFD4B8 (nomenclature_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE unit (id INT AUTO_INCREMENT NOT NULL, name JSON NOT NULL COMMENT \'(DC2Type:json)\', code INT NOT NULL, icon VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, username VARCHAR(255) NOT NULL, qr_code VARCHAR(255) DEFAULT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F5B7AF75 (address_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), UNIQUE INDEX UNIQ_IDENTIFIER_NAME (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_credential (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, type VARCHAR(255) NOT NULL, value LONGTEXT NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, INDEX IDX_A218DBA77E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_store (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, store_id INT NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE web_credential (id INT AUTO_INCREMENT NOT NULL, multi_store_id INT NOT NULL, class_list LONGTEXT NOT NULL, article INT NOT NULL, insta_login VARCHAR(255) NOT NULL, insta_password VARCHAR(255) NOT NULL, ftp_login VARCHAR(255) NOT NULL, ftp_password VARCHAR(255) NOT NULL, ftp_ip VARCHAR(255) NOT NULL, ftp_image_path VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE web_nomenclature (id INT AUTO_INCREMENT NOT NULL, nomenclature_id INT DEFAULT NULL, article VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, document VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(), deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_FE9BA2AC90BFD4B8 (nomenclature_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
