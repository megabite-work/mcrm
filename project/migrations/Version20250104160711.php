 ...
 */
final class Version20250104160711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_banner_setting DROP title');
        $this->addSql('ALTER TABLE web_block ADD title VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_banner_setting ADD title VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE web_block DROP title');
    }
}
