...
final class Version20241217101416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_banner CHANGE begin_at begin_at VARCHAR(255) NOT NULL, CHANGE end_at end_at VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_banner CHANGE begin_at begin_at DATETIME NOT NULL, CHANGE end_at end_at DATETIME DEFAULT NULL');
    }
}
