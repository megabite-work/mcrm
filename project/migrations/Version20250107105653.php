 ...
 */
final class Version20250107105653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD token VARCHAR(255) DEFAULT NULL, ADD expires_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP token, DROP expires_at');
    }
}
