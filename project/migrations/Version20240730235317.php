 ...
 */
final class Version20240730235317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE multi_store (id INT NOT NULL, owner_id INT NOT NULL, name VARCHAR(255) NOT NULL, profit TEXT DEFAULT NULL, barcode_TTN INT DEFAULT NULL, nds INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_A869D5AB7E3C61F9 ON multi_store (owner_id)');
        $this->addSql('CREATE TABLE nomenclature (id INT NOT NULL, category_id INT NOT NULL, unit_id INT NOT NULL, mxik VARCHAR(255) NOT NULL, barcode VARCHAR(255) NOT NULL, brand VARCHAR(255) NOT NULL, name JSON NOT NULL, oldprice NUMERIC(15, 3) NOT NULL, price NUMERIC(15, 3) NOT NULL, oldprice_course NUMERIC(15, 3) NOT NULL, price_course NUMERIC(15, 3) NOT NULL, nds NUMERIC(15, 3) NOT NULL, discount NUMERIC(15, 3) NOT NULL, provider_id INT NOT NULL, qr_code BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE store (id INT NOT NULL, multi_store_id INT NOT NULL, name VARCHAR(255) NOT NULL, is_active BOOLEAN DEFAULT NULL, official_address VARCHAR(255) DEFAULT NULL, coordinate VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_FF5758777B4D9FBF ON store (multi_store_id)');
        ...
        $this->addSql('ALTER TABLE multi_store ADD CONSTRAINT FK_A869D5AB7E3C61F9 FOREIGN KEY (owner_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE store ADD CONSTRAINT FK_FF5758777B4D9FBF FOREIGN KEY (multi_store_id) REFERENCES multi_store (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE multi_store DROP CONSTRAINT FK_A869D5AB7E3C61F9');
        $this->addSql('ALTER TABLE store DROP CONSTRAINT FK_FF5758777B4D9FBF');
