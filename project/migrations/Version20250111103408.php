 ...
 */
final class Version20250111103408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_banner CHANGE description description LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_banner CHANGE description description LONGTEXT NOT NULL');
    }
}
