 ...
 */
final class Version20240826092929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_nomenclature CHANGE image images VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_nomenclature CHANGE images image VARCHAR(255) DEFAULT NULL');
    }
}
