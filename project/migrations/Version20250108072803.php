 ...
 */
final class Version20250108072803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_credential ADD logo VARCHAR(255) DEFAULT NULL, ADD about LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_credential DROP logo, DROP about');
    }
}
