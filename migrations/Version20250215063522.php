 ...
 */
final class Version20250215063522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_2CC96A32FE54D947 ON attribute_entity (group_id)');
        ...
        $this->addSql('ALTER TABLE web_banner CHANGE type_id type_id LONGTEXT NOT NULL');
        $this->addSql('ALTER TABLE web_event CHANGE move move INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_2CC96A32FE54D947 ON attribute_entity');
        ...
        $this->addSql('ALTER TABLE web_event CHANGE move move INT DEFAULT NULL');
    }
}
