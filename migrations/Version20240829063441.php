 ...
 */
final class Version20240829063441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_nomenclature ADD show_comment TINYINT(1) DEFAULT 1 NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_nomenclature DROP show_comment');
    }
}
