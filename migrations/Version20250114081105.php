 ...
 */
final class Version20250114081105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_footer_body DROP logo, DROP about, DROP is_active');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_footer_body ADD logo VARCHAR(255) NOT NULL, ADD about VARCHAR(255) NOT NULL, ADD is_active TINYINT(1) DEFAULT 1 NOT NULL');
    }
}
