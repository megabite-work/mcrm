 ...
 */
final class Version20250113064309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE web_header (id INT AUTO_INCREMENT NOT NULL, multi_store_id INT NOT NULL, type VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, `order` INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
