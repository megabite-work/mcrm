 ...
 */
final class Version20250113072715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_banner ADD show_type VARCHAR(255) DEFAULT NULL, ADD show_type_id VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE web_credential ADD catalog_type VARCHAR(255) DEFAULT NULL, ADD catalog_type_id LONGTEXT DEFAULT NULL, ADD buy_type VARCHAR(255) DEFAULT NULL, ADD buy_value VARCHAR(255) DEFAULT NULL, DROP category');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_banner DROP show_type, DROP show_type_id');
        ...
        $this->addSql('ALTER TABLE web_credential ADD category VARCHAR(255) NOT NULL, DROP catalog_type, DROP catalog_type_id, DROP buy_type, DROP buy_value');
    }
}
