 ...
 */
final class Version20240906064211 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_credential CHANGE social social LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE web_credential CHANGE social social VARCHAR(255) DEFAULT NULL');
    }
}
