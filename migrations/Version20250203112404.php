 ...
 */
final class Version20250203112404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attribute_entity ADD unit VARCHAR(255) DEFAULT NULL, ADD group_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attribute_entity DROP unit, DROP group_id');
